...
local L_33_ = https://you.whimper.xyz/sources/RDHub/ui.lua
local L_34_ = L_33_:Window("rd Hub 25ms was here", Enum.KeyCode.LeftControl)
print("|RD HUB DEBUG| Anti AFK")
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|RD HUB DEBUG| AFK detected, prevented +1")
...
spawn(function()
	print("|RD HUB DEBUG| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("RD HUB Hub found an Admin!")
						print("|RD HUB DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|RD HUB DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|RD HUB DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
L_35_.Info:Button("My Youtube (Click Copy)", function()
	setclipboard("https://www.youtube.com/@RD_SCRIPTSX")
end)
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|RD HUB DEBUG| Remove Effects")
...
print("|RD HUB DEBUG| Done loaded RD HUB in: " .. os.clock() - L_1_)
